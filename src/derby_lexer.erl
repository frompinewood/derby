...
yystate(3, [104|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(2, Ics, Line, Col, Tlen+1, Action, Alen);
...
-file("src/derby_lexer.xrl", 8).
yyaction_0(TokenLine) ->
     { token, { die, TokenLine, d } } .

-compile({inline,yyaction_1/2}).
-file("src/derby_lexer.xrl", 9).
yyaction_1(TokenChars, TokenLine) ->
     { token, { int, TokenLine, list_to_integer (TokenChars) } } .

-compile({inline,yyaction_2/2}).
-file("src/derby_lexer.xrl", 10).
yyaction_2(TokenChars, TokenLine) ->
     { token, { mod, TokenLine, expand_mod (list_to_atom (TokenChars)) } } .

-compile({inline,yyaction_3/0}).
-file("src/derby_lexer.xrl", 11).
yyaction_3() ->
     skip_token .
